        ...
        <div class="col-lg-4-5">
            <div class="shop-product-fillter">
                <div class="totall-product">
                    <p>We found <strong class="text-brand">{{ count($VendProduct) }}</strong> items for you!</p>
                </div>
            ...
            <div class="row product-grid">
                ...
                @foreach ($VendProduct as $product)
                        ...
                        <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn" data-wow-delay=".1s">
                            ...
                            <div class="product-content-wrap">
                                ...
                                <div class="product-card-bottom">
                                    ...
                                    <div class="product-price">
                                        <span>${{ $product->selling_price }}</span>
                                        <span class="old-price">${{ $product->selling_price - $product->discount_price }}</span>
                                    </div>
                                    @endif
        ...
        <div class="col-lg-1-5 primary-sidebar sticky-sidebar">
            <div class="sidebar-widget widget-store-info mb-30 bg-3 border-0">
                <div class="vendor-logo mb-30">
                    <img src="{{ (!empty($vendor->photo)) ? url('upload/vendor_images/'.$vendor->photo) : url('upload/no_image.png')}}" alt="" />
                </div>
