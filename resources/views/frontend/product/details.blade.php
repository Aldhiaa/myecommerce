                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12 mb-md-0 mb-sm-5">
                            <div class="detail-gallery">
                                ...
                                <div class="slider-nav-thumbnails">
                                    @foreach ($multimage as $img)
                                    <div><img src="{{ asset($img->photo_name) }}" alt="" /></div>
                                    @endforeach
                                </div>
                            </div>
                            <!-- End Gallery -->
                            ...
                            <div class="detail-info pr-30 pl-30">
                                ...
                                <div class="clearfix product-price-cover">
                                    <div class="product-price primary-color float-left">
                                        ...
                                        <span class="current-price text-brand" id="sellprice">${{ $product->selling_price }}</span>
                                        @else
                                        <span class="current-price text-brand" id="sellprice">${{ $product->selling_price - $product->discount_price }}</span>
                                        <span>
                                            @php                                       
                                ...
                                <div class="short-desc mb-30">
                                    <p class="font-lg">{{ $product->short_describtion }}</p>
                                </div>
                               ...
                               <div class="attr-detail attr-size mb-30">
                                ...
                                <div class="detail-extralink mb-50">
                                    <div class="detail-qty border radius">
                                        ...
                                        <input type="text" id="qty" name="quantity" class="qty-val" value="1" min="1">
                                        <a href="#" class="qty-up"><i class="fi-rs-angle-small-up"></i></a>
                                    </div>
                                    <div class="product-extra-link2">
                                        <input type="hidden" id="product_id" value="{{ $product->id }}" />
                                        <input type="hidden" id="pvendor_id" value="{{ $product->vendor->id }}" />
                                ...
                                @if ($product->vendor_id == Null)
                                   <h6>Sold By<span class="class text-danger">Owner</span></h6> 
                                @else
                                    <h6>Sold By<span class="class text-danger">{{ $product->vendor->name }}</span></h6>     
                                @endif
                                <hr>
                                  <div class="font-xs">
                            ...
                            <div class="tab-content shop_info_tab entry-main-content">
                                ...
                                <div class="tab-pane fade" id="Vendor-info">
                                    <div class="vendor-logo d-flex mb-30">
                                        <img src="{{ (!empty($product->vendor->photo)) ? url('upload/vendor_images/'.$product->vendor->photo) : url('upload/no_imagae.png')}}" alt="" />
