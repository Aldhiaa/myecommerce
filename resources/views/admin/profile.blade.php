                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-column align-items-center text-center">
                                    <img src="{{ (!empty($adminInfo->photo)) ? url('upload/admin_images/'.$adminInfo->photo) : url('upload/no_imagae.png')}}" alt="Admin" class="rounded-circle p-1 bg-primary" width="110" onclick="openFileDialog()">
                                    <form id="photo-form" action="{{ route('update.photo') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
